...
@Autonomous
public class TermigatorsAutoRed extends OpMode {
    ...
    public void start() {
        ...
        if (robot.colorsense.red() > robot.colorsense.blue()) {
            ...
            //Turn robot clockwise to knock off blue jewel
        ...
        else if (robot.colorsense.blue() > robot.colorsense.red()) {

            //Turn robot counterclockwise to knock off blue jewel
            robot.turnCounterclockEnc(1, 180);

            //Display message to show that the correct action is preformed
            telemetry.addData("The jewel blue", robot.colorsense.blue());
            telemetry.update();
